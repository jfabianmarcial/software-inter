...
4. **Notificaciónes:** Algoritmo de cruce automático con alertas al alumno, aviso al administrador y panel de confirmación.
...
* **Notificaciónes:** Algoritmo automático que cruza datos y envía alertas inmediatas ante una coincidencia.
